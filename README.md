...
**Spring Boot Starter for debezium-embedded**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/debezium-embedded-spring-boot-starter)](https://github.com/easy-4-java/debezium-embedded-spring-boot-starter)
...
> **Current Version**：`2.3.x.20250820-SNAPSHOT`<br>
> **JDK Baseline**：`1.8`<br>
...
**debezium-embedded-spring-boot-starter** is a Spring Boot starter that integrates **debezium-embedded** for applications using debezium-embedded. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume debezium-embedded capabilities with minimal setup.
...
| JDK | `1.8` |
| Coordinates | `io.github.easy4j:debezium-embedded-spring-boot-starter:2.3.x.20250820-SNAPSHOT` |
...
| `RowEventHandler` | classpath + property | not created |
...
<dependency>
    ...
    <version>2.3.x.20250820-SNAPSHOT</version>
</dependency>
```
...
|---|---|---|:---:|---|:---:|
| `debezium.embedded.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl debezium-embedded-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `debezium.embedded.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/debezium-embedded-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/debezium-embedded-spring-boot-starter)
